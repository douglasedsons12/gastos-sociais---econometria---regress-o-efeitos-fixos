...
Para visualizar o esboço da pesquisa, com conclusões mais detalhados e análise exploratória dos resultados, consultar  [Visualizar Resumo Técnico (PDF)](./Parte_Escrita.pdf).
